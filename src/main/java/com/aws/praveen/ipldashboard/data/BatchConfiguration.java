...
public class BatchConfiguration {
    ...
    private final String[] MATCH_INPUT_FIELD_NAMES = new String[] { "id", "city","date", "player_of_match",
            "venue","neutral_venue", "team1", "team2", "toss_winner", "toss_decision", "winner", "result",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("matchInputItemReader")
                .resource(new ClassPathResource("match-data.csv")).delimited().names(MATCH_INPUT_FIELD_NAMES)
